		   ...
		   if (ann['scope'] == 'site-wide' || notifScope == ann['scope']) {  //if in scope
				...
				if ( ! hasAnnBeenDismissed( ann['id'] ) ) { //show alert
					svrty =  ann['severity'].toLowerCase();
					   ...
					   out = '\n<div class=" alert alert-site-wide alert-primary alert-dismissable mb-0" style="background-color:#'+(['warning', 'severe'].includes(svrty)?'c12e2a':'022d3a')+';border:0;" role="alert" id="'+ann['id']+'">';
